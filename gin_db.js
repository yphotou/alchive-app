...
const GIN_DB = {
  ...
  "4589633900018": {
    ...
    abv: 40,
    volume_ml: 700,
    description_short: "クリアで洗練された味わい。柑橘とジュニパーのバランスが良く、カクテルベースとしても定番の1本。",
    gin_base: "Grain Spirits",
    gin_style: "London Dry",
    botanicals: "Grains of Paradise, Orris, Liquorice, Cubeb, Coriander, Cassia Bark, Juniper, Angelica root, Bitter Almond, Fresh Lemon Peel",
